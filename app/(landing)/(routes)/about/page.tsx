  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="text-center" style={{ marginTop: '-400px' }}>
        ...
        <p className="text-white text-xl max-w-2xl mx-auto animate-gradientFadeIn landing-font">
          Welcome to Kiraka, the platform for enhancing your reading and learning efficiency. 
